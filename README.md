...
![Snake animation](https://raw.githubusercontent.com/liassuo/liassuo/output/snake.svg)

---

## 🧠 Sobre mim
- Desenvolvedor em formação com experiência prática em ambiente corporativo
- Atuação com **frontend e backend**
- Interesse em arquitetura de software, APIs e sistemas bem modelados
- Background em **engenharia e programação de baixo nível**
...
**Top Construtora** — Desenvolvedor Estagiário  
📍 Departamento de Inovações e Tecnologia  

- Desenvolvimento e manutenção de sistemas internos
- Criação de APIs com **Node.js e NestJS**
- Desenvolvimento frontend com **React, Angular e TypeScript**
- Integração com banco de dados **PostgreSQL** usando **Prisma**
- Versionamento e trabalho colaborativo com **Git/GitHub**
...
Python • SQL • Interface Gráfica  
> Sistema para cadastro, edição e gerenciamento de produtos com persistência em banco de dados.

🔹 **[Agenda de Contatos](https://github.com/liassuo/AgendaContatos)**  
Java • Swing • Banco de Dados  
> Aplicação desktop para gerenciamento de contatos com integração a banco de dados.

🔹 **[Gerador de Senhas](https://github.com/liassuo/GeradorSenhas)**  
Python • Criptografia Local  
> Aplicação para geração de senhas seguras com criptografia local.
